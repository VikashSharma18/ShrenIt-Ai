...
const AptitudeSprint = () => {
    ...
    const startTest = (testType) => {
        ...
        setCurrentTest(generateTest(testType));
        setUserAnswers({});
    ...
    const generateTest = (testType) => {
        ...
        return shuffleArray(pools[testType]).slice(0, 25);
    };
            ...
            <div className="aptitude-container">
                <div className="test-interface">
                    ...
                    <div className="navigation-controls">
                        ...
                        >
                            {currentQuestionIndex === currentTest.length - 1 ? 'Submit Test' : 'Next →'}
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    {Object.keys(testTitles).map((testType) => (
                        ...
                        >
                            ...
                            <p className="card-description">
                                {testType === 'quantitative' && 'Mathematics, Algebra & Data Analysis'}
                                {testType === 'verbal' && 'Grammar, Vocabulary & Critical Reasoning'}
                                {testType === 'logical' && 'Puzzles, Patterns & Logical Sequences'}
