      ...
      <div className="about-content-wrapper">
        ...
        >
          <div className="about-image-frame ">
            <img src={FounderImage} alt="Founder" className="about-portrait" />
          </div>
        ...
        >
          ...
          <motion.p variants={itemVariants} className="about-message-text">
            I firmly believe education should be fundamentally simple,
            universally accessible, and meticulously aligned with students'
            genuine needs.
          </motion.p>

          <motion.p variants={itemVariants} className="about-message-text">
            This platform was born from the vision to transcend basic syllabus
            organization and interview preparation - it's about revolutionizing
            the entire academic journey through intelligent AI integration.
          </motion.p>

          <motion.p variants={itemVariants} className="about-message-text">
            Every feature embodies deliberate purpose: simplifying complex
            learning processes, elevating interview readiness, and fostering
            meaningful academic connections. My mission remains clear: bridge
            the critical gap between theoretical knowledge and practical
